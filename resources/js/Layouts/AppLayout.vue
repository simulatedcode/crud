...
import ApplicationMark from '@/Components/AdminPanel/ApplicationMark.vue';
import Banner from '@/Components/AdminPanel/Banner.vue';
import Dropdown from '@/Components/AdminPanel/Dropdown.vue';
import DropdownLink from '@/Components/Adminpanel/DropdownLink.vue';
import NavLink from '@/Components/AdminPanel/NavLink.vue';
import ResponsiveNavLink from '@/Components/AdminPanel/ResponsiveNavLink.vue';
import CarbonCheckmarkOutline from '~icons/carbon/checkmark-outline'
import Success from '@/Components/ArtistComponents/Success.vue';
import Error from '@/Components/ArtistComponents/Error.vue';
import Update from '@/Components/ArtistComponents/Update.vue';
                            ...
                            <div class="ml-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <div class="flex items-center">
                                            <span v-if="$page.props.is_admin">
                                                <CarbonCheckmarkOutline class="mr-2 text-blue-700"/>
                                            </span>
                                            Profile {{ $page.props.is_admin ? '(Admin)' : '' }}
                                        </div>
                                        </DropdownLink>
